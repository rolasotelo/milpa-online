...
export type OldGameContextType = {
  nickname: string;
  roomCode: string;
...
export const OldGameContext = createContext<OldGameContextType>(null!);
...
const OldGameProvider = (props: Props) => {
...
export default OldGameProvider;
